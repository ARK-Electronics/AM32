...
uint16_t led_Buffer[28] = {
	0, 0, 20, 20, 20, 20, 20, 20, 20, 20, 60, 60, 60, 60, 60, 60, 60, 60, 20, 20, 20, 20, 20, 20, 20, 20, 0, 0,
};
void send_LED_DMA()
{
	dma_busy = 1;
	TIM16->CNT = 0;
	LL_DMA_ConfigAddresses(DMA1, LL_DMA_CHANNEL_6, (uint32_t)&led_Buffer, (uint32_t)&TIM16->CCR1,

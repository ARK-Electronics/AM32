...
#define SET_AND_ENABLE_COM_INT(time)                                                                                                       \
	(COM_TIMER->CNT = 0, COM_TIMER->ATRLR = time, COM_TIMER->INTFR = 0x00, COM_TIMER->DMAINTENR |= TIM_IT_Update)
...
#define SET_DUTY_CYCLE_ALL(newdc) (TIM1->CH1CVR = newdc, TIM1->CH2CVR = newdc, TIM1->CH3CVR = newdc)

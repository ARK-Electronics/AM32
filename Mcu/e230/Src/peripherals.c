...
void LED_GPIO_init()
{
	...
	gpio_mode_set(RED_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, RED_PIN);
	gpio_output_options_set(RED_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, RED_PIN);

	gpio_mode_set(GREEN_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GREEN_PIN);
	gpio_output_options_set(GREEN_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GREEN_PIN);

	gpio_mode_set(BLUE_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, BLUE_PIN);
	gpio_output_options_set(BLUE_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, BLUE_PIN);
}
